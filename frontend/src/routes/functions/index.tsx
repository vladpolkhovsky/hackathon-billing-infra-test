  ...
  useEffect(() => {
    if (activeFunction && activeFunction.id) {
      client.GET('/v1/details', {
        params: { query: { functionId: activeFunction.id, tariffId: '0199ea25-117f-76d2-b3a8-a4a22958e3f1', period: 'MINUTE', from: 1760504471014, to: 1760574471014 } },
      }).then((res) => {
  ...
  return (
    <div className="w-full pr-4">
      <div className="items-center">
        ...
        {activeFunction && 
          <FunctionRoute activeFunction={activeFunction} setActiveFunction={setActiveFunction} functionInfo={functionInfo} />
        }
      </div>
    </div>
  );
